# server部署示例
当前版本支持的[注册中心](/zh-cn/aggdocs/tutorial/registry/index.html)有：  
- direct(默认，不支持实时扩缩容)  
- nacos  
- zookeeper  
...
下载最新的安装包tcc-transaction-server-xxx.tar.gz，依次
...
server % 
```
conf/application.yaml[详细配置详见](/zh-cn/docs/tutorial/configurations.html#server端)  
